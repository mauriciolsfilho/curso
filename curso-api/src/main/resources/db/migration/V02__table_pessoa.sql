...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Maria Rita', 'Rua do SabiÃ¡', '110', 'Apto 101', 'Colina', '11.400-120', 'Ribeirão Preto', 'SP', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Pedro Santos', 'Rua da Bateria', '23', null, 'Morumbi', '54.212-120', 'Goiãnia', 'GO', true);
...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Leonardo Oliveira', 'Rua do Mágico', '566', null, 'Segismundo Pereira', '38.400-000', 'Uberlândia', 'MG', true);
...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Luan Campos', 'Rua Dos Benvindos', '101', 'casa C', 'Caiçaras', '38.702-174', 'Patos de Minas', 'MG', true);